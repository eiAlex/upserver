...
class FileServer:
    ...
    def __init__(self, upload_dir="uploads", host="0.0.0.0", port=8000, chunk_size=5*1024*1024):
        """
    ...
    def _print_startup_info(self):
        ...
        print(f"💡 Tip: Open http://{self.host if self.host != '0.0.0.0' else 'localhost'}:{self.port} in browser to upload, list and download files")
